...
public class ManageApplications extends InstrumentedPreferenceFragment
    ...
    public static final int FILTER_APPS_SUBSTRATUM = 13;
    public static final int FILTER_APPS_SUBSTRATUM_ICONS = 14;
    public static final int FILTER_APPS_COUNT = 15;  // This should always be the last entry
